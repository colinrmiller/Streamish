...
namespace Streamish.Repositories
{
    ...
    public class VideoRepository : BaseRepository, IVideoRepository
    {
                ...
                using (var cmd = conn.CreateCommand())
                {
                    ...
                    using (SqlDataReader reader = cmd.ExecuteReader())
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            if (DbUtils.IsNotDbNull(reader, "CommentId"))
                            {
                                video.Comments.Add(NewCommentFromReader(reader));
                            }
                        }
        ...
        public List<Video> Hottest(string since)
        {
            using (var conn = Connection)
            {
                conn.Open();
                using (var cmd = conn.CreateCommand())
                {
                    ...
                    cmd.CommandText = sql;
                    DbUtils.AddParameter(cmd, "@Since", DateTime.Parse(since));
                    using (SqlDataReader reader = cmd.ExecuteReader())
                    {
        ...
        public Video NewVideoFromReader(SqlDataReader reader)
        {
            return new Video()
            {
        ...
        public Comment NewCommentFromReader(SqlDataReader reader)
        {
            return new Comment()
            {
                Id = DbUtils.GetInt(reader, "CommentId"),
